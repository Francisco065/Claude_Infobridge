...
async def _salvar_indicador(conn: asyncpg.Connection, ind: dict):
    await conn.execute(
        ...
        DO UPDATE SET
            ...
            odometro_inicial_km = EXCLUDED.odometro_inicial_km,
            odometro_final_km = EXCLUDED.odometro_final_km,
            consumo_total_litros = EXCLUDED.consumo_total_litros,
            media_km_l = EXCLUDED.media_km_l,
            velocidade_media_kmh = EXCLUDED.velocidade_media_kmh,
            velocidade_max_kmh = EXCLUDED.velocidade_max_kmh,
            frenagens_totais = EXCLUDED.frenagens_totais,
            frenagens_normais = EXCLUDED.frenagens_normais,
            frenagens_bruscas = EXCLUDED.frenagens_bruscas,
            frenagens_alta_velocidade = EXCLUDED.frenagens_alta_velocidade,
            frenagens_por_100km = EXCLUDED.frenagens_por_100km,
            perc_acel_ideal = EXCLUDED.perc_acel_ideal,
            perc_acel_atencao = EXCLUDED.perc_acel_atencao,
            perc_acel_critico = EXCLUDED.perc_acel_critico,
            perc_faixa_verde_inicial = EXCLUDED.perc_faixa_verde_inicial,
            perc_faixa_verde_final = EXCLUDED.perc_faixa_verde_final,
            perc_freio_motor_ok = EXCLUDED.perc_freio_motor_ok,
            perc_freio_motor_acel = EXCLUDED.perc_freio_motor_acel,
            perc_embalo = EXCLUDED.perc_embalo,
            perc_motor_ocioso = EXCLUDED.perc_motor_ocioso,
            tempo_motor_ocioso_penalizado_s = EXCLUDED.tempo_motor_ocioso_penalizado_s,
